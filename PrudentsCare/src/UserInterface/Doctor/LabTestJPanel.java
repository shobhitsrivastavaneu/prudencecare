...
public class LabTestJPanel extends javax.swing.JPanel {
   ...
   PatientHospitalAppointmentWorkRequest request;
    LabTestJPanel(JPanel userProcessContainer, UserAccount account,Enterprise enterprise, EcoSystem ecosystem,PatientHospitalAppointmentWorkRequest request) {
        initComponents();
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        DoctorPanel dwjp = (DoctorPanel) component;
        dwjp.populateTable();
