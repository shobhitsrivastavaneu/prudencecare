 ...
 */
public class PatientRecordJPanel extends javax.swing.JPanel {

    /**
     * Creates new form PatientRecordJPanel
     */
    EcoSystem ecosystem;
   ...
   String timeLinePharmacy;
    ...
    public PatientRecordJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Hospital Record");
        ...
        jButton2.setText("Pharmacy Record");
        ...
        jButton3.setText("Laboratory Record");
        ...
        jLabel4.setText("'s Record");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, -1, -1));

        btnGeneratePdf.setBackground(new java.awt.Color(242, 242, 242));
        ...
        jLabel1.setText("HOSPITAL APPOINTMENT RECORD");
        ...
        btnHosTimeline.setBackground(new java.awt.Color(242, 242, 242));
...
//                     }
                ...
                Logger.getLogger(PatientRecordJPanel.class.getName()).log(Level.SEVERE, null, ex);
