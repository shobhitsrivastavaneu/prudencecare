...
public class PatientJPanel extends javax.swing.JPanel {
    ...
    public PatientJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem ecosystem, InsuranceAdminOrganization organization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 70, 250, 130));

        btnRegisterForInsurance.setBackground(new java.awt.Color(0, 0, 0));
        ...
        add(btnRegisterForInsurance, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 250, 130));
        ...
        btnEmergency.setText("Ambulance (Emergency) ");
        ...
        add(btnEmergency, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 250, 130));

        btnBookLab.setBackground(new java.awt.Color(0, 0, 0));
        ...
        add(btnBookLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 250, 130));

        btnMedReq.setBackground(new java.awt.Color(0, 0, 0));
        ...
        add(btnMedReq, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 330, 250, 130));
        ...
        add(btnPatientHistory, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 70, 250, 130));
        ...
        for (Patient p : ecosystem.getPatientDirectory().getpatientlist()) {
            if (p.getUserName().equals(account.getUsername())) {
                ...
                if (p.getInsurance() == null) {
                    ...
                    BookLaboratoryJPanel bookLabJPanel = new BookLaboratoryJPanel(userProcessContainer, account, enterprise, ecosystem);
