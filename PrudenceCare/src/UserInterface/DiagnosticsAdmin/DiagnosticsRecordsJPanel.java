 ...
 */
public class DiagnosticsRecordsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form DiagnosticsRecordsJPanel
     */
        JPanel userProcessContainer;
    Enterprise enterprise;
    EcoSystem business;
    UserAccount account;
    public DiagnosticsRecordsJPanel(JPanel userProcessContainer,UserAccount account, Enterprise enterprise,EcoSystem business) {
        initComponents();
 ...
 private  Map<String,Date> sortByDate(Map<String, Date> map){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DIAGNOSTICS RECORDS");
