...
import Business.WorkQueue.DiagnosticsTestWorkRequest;
 ...
 */
public class DiagnosticsReportJPanel extends javax.swing.JPanel {
        private JPanel userProcessContainer;
    private EcoSystem business;  
    private Enterprise enterprise;
    private UserAccount account;
    public DiagnosticsReportJPanel(JPanel userProcessContainer,UserAccount account,Enterprise enterprise,EcoSystem business ) {
        initComponents();
...
public void populateAgeGroupChart(){
        ...
        for(DiagnosticsPatientWorkRequest request : business.getLabPatQueue().getLabPatientRequestList()){
            int age = 0;
...
public void populateServices(){
    ...
    DiagnosticsEnterprise e = (DiagnosticsEnterprise) enterprise;
    for(String i: e.getServices()){
        int count = 0;
        for(DiagnosticsPatientWorkRequest req: business.getLabPatQueue().getLabPatientRequestList()){
    ...
    private void initComponents() {
        ...
        jButton1.setText("DIAGNOSTICS RECORDS");
        ...
        activeTable.setBackground(new java.awt.Color(182, 220, 237));
        ...
        jLabel2.setText("COVID-19 POSITIVE RECORDS");
        ...
        servicesPanel.setBackground(new java.awt.Color(182, 220, 237));
        ...
        jLabel1.setText("DIAGNOSTICS REPORT");
        ...
        enterpriseLabel.getAccessibleContext().setAccessibleName("Enterprise :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        DiagnosticsRecordsJPanel viewRepJPanel = new DiagnosticsRecordsJPanel(userProcessContainer,account,enterprise,business);
