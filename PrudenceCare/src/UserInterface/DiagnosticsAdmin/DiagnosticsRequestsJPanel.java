 ...
 */
public class DiagnosticsRequestsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form DiagnosticsAdminWorkAreaJPanel
     */
    ...
    EcoSystem business;
    public DiagnosticsRequestsJPanel(JPanel userProcessContainer, UserAccount account, DiagnosticsOrganization LabOrganization, Enterprise enterprise,EcoSystem business) {
        initComponents();
    ...
    public void populateStaffBox(){
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            for (UserAccount ua : organization.getUserAccountDirectory().getUserAccountList()) {
                   if(ua.getRole().toString().equals("DiagnosticsCrew")){
    ...
    public void populateLabTests(){
        ...
        model.setRowCount(0);
        for(DiagnosticsPatientWorkRequest work : account.getLabPatientWorkQueue().getLabPatientRequestList()){
    ...
    private void btnAssignLabReq1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignLabReq1ActionPerformed
        ...
        DiagnosticsPatientWorkRequest labReq= (DiagnosticsPatientWorkRequest)labTestingTable.getValueAt(selectedRow, 0);
